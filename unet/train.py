...
class AirbusDataset(Dataset):
    def __init__(self, data_dir, data_set, transform=None):
        ...
        self.img_transform = img_transform = transforms.Compose([transforms.ToTensor(),
    ...
    def  __getitem__(self ,index):
        ...
        #     imgO, mask = self.transform(imgO, mask)
        ...
        print(imgO.shape)
        print(mask.shape)
        print(torch.max(imgO))
        print(torch.min(imgO))
...
if __name__ == "__main__":
    ...
    train_dataset = AirbusDataset(ship_dir, train_df, transform = train_transform)
